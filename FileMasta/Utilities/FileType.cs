...
namespace FileMasta.Utilities
{
    class FileType
    {
        ...
        public static string[] Executable { get; } = new string[] { "BAT", "CMD", "EXE", "MSI", "MSP", "SCR" };
        public static string[] Picture { get; } = new string[] { "ANI", "BMP", "GIF", "ICO", "JPE", "JPEG", "JPG", "PCX", "PNG", "PSD", "TGA", "TIF", "TIFF", "WMF" };
        public static string[] Video { get; } = new string[] { "3G2", "3GP", "3GP2", "3GPP", "AMR", "AMV", "ASF", "AVI", "BDMV", "BIK", "D2V", "DIVX", "DRC", "DSA", "DSM", "DSS", "DSV", "EVO", "F4V", "FLC", "FLI", "FLIC", "FLV", "HDMOV", "IFO", "IVF", "M1V", "M2P", "M2T", "M2TS", "M2V", "M4B", "M4P", "M4V", "MKV", "MP2V", "MP4", "MP4V", "MPE", "MPEG", "MPG", "MPLS", "MPV2", "MPV4", "MOV", "MTS", "OGM", "OGV", "PSS", "PVA", "QT", "RAM", "RATDVD", "RM", "RMM", "RMVB", "ROQ", "RPM", "SMIL", "SMK", "SWF", "TP", "TPR", "TS", "VOB", "VP6", "WEBM", "WM", "WMP", "WMV" };
